  ...
  return (
    <div className='m-6'>
     ...
     <section >
        ...
        <div className=''>
          <div>
          <p className='fadein text-gray-700 text-[.9rem] font-[350] font-[lora] '>
          ...
          <NavLink to={'https://github.com/wheel-s'} target='blank'><img src={github} width={44} className='mr-4 bg-gray-100 rounded-md p-1 '/></NavLink>
         ...
         <a href='mailto:toshiro2002@gmial.com'><button className='fadein bg-gray-700 cursor-pointer rounded-lg  py-[13px] w-60  text-[1.1rem] font-bold ring-1 ring-gray-900 text-gray-50'>Send  message</button></a>     
        </div>
      </section>
